...
public class SaOperatePointAction extends QuestAction{
	...
	public ArrayList<String> getWikiDesc() {
		return new ArrayList<String>(Arrays.asList(
				"&bOperate skill point of a",
				"&bclass with given operations."
				));
	}
	...
	public void execute(Player p) {
		...
		case "DECREASE":
			...
			cl.setPoints((current-amount > -1?current-amount:0));
			break;
		case "INCREASE":
			cl.givePoints(amount);
