...
@QuestConditionMark(conditionID = "checkSkillAPISkillPoint")
public class SaCheckSkillPointCondition extends QuestCondition{
	private static final long serialVersionUID = 1L;
	private Integer amount;
	private String plClass;
	private String operation;
	public SaCheckSkillPointCondition() {
		...
		plClass = "nothing";
		amount = 5;
		setDisplayName("&eYour <name>'s skill points must <operation> to <amount>");
		setErrMessage("&eYour <name>'s skill points is not <operation> to <amount>");
	}
	@Override
	...
	public ArrayList<String> getWikiDesc() {
		return new ArrayList<String>(Arrays.asList(
				"&bCheck available skill points",
				"&bof a class with given operations."
				));
	}
	@Override
